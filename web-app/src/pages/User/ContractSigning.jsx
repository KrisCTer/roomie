...
const ContractSigning = () => {
  ...
  const isAlreadySigned =
    userRole === "tenant" ? contract.tenantSigned : contract.landlordSigned;

  const otherPartySigned =
    userRole === "tenant" ? contract.landlordSigned : contract.tenantSigned;
    ...
    <div className="bg-white rounded-xl shadow-sm p-6">
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
          {contract.tenantSigned && contract.landlordSigned
            ? "Cả hai bên đã ký hợp đồng. Hợp đồng sẽ có hiệu lực sau khi hoàn tất thanh toán tiền đặt cọc."
          ...
          <div className="bg-blue-50 rounded-lg p-6 mb-6 max-w-2xl mx-auto">
            ...
            <ul className="text-left space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2">
                ...
                Hợp đồng sẽ được kích hoạt sau khi thanh toán thành công
              </li>
              <li className="flex items-start gap-2">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
              ...
              <div className="p-4 h-[70vh] bg-gray-100 flex items-center justify-center">
                <p className="text-gray-500">PDF Preview sẽ hiển thị ở đây</p>
              </div>
            </div>
          </div>
        )}

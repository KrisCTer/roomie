...
| ---------------- | --------- | ---------------------------------------------------------------- |
| **React**        | v19.x     | View library, component lifecycle                                |
...
_Nếu có thắc mắc trong quá trình code UI, hãy hỏi Agent `@frontend-specialist`._
...
_Nếu có thắc mắc trong quá trình code Backend, hãy hỏi Agent `@backend-specialist`._

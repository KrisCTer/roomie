// web-app/src/services/contractService.js
 ...
 */
export const tenantSignContract = (contractId, payload) =>
  BaseService.post(API.TENANT_SIGN_CONTRACT(contractId), payload);

/**
 * Verify OTP and sign contract (Landlord)
 */
export const landlordSignContract = (contractId, payload) =>
  BaseService.post(API.LANDLORD_SIGN_CONTRACT(contractId), payload);
